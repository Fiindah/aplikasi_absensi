    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        try {
          final errorJson = jsonDecode(response.body);
          return AttendanceResponse(
            message: errorJson['message'] ?? 'Gagal melakukan absen masuk.',
            errors: errorJson['errors'],
            data: null,
          );
        } on FormatException catch (e) {
          debugPrint(
            'Error parsing check-in error response (FormatException): $e',
          );
          return AttendanceResponse(
            message:
                'Gagal absen masuk. Respon server tidak valid (bukan JSON): ${response.body}',
            data: null,
          );
        } catch (e) {
          debugPrint('Error parsing check-in error response: $e');
          return AttendanceResponse(
            message:
                'Gagal absen masuk. Terjadi kesalahan saat memproses respon server: ${response.body}',
            data: null,
          );
        }
      }
      ...
      return AttendanceResponse(
        message:
            'Tidak dapat terhubung ke server untuk absen masuk. Periksa koneksi internet Anda.',
        data: null,
      );
    }
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        try {
          ...
          debugPrint(
            'Error parsing check-out error response (FormatException): $e',
          );
          return AttendanceResponse(
            message:
                'Gagal absen pulang. Respon server tidak valid (bukan JSON): ${response.body}',
            data: null,
          );
        } catch (e) {
          debugPrint('Error parsing check-out error response: $e');
          return AttendanceResponse(
            message:
                'Gagal absen pulang. Terjadi kesalahan saat memproses respon server: ${response.body}',
            data: null,
          );
        }
      }
      ...
      return AttendanceResponse(
        message:
            'Tidak dapat terhubung ke server untuk absen pulang. Periksa koneksi internet Anda.',
        data: null,
      );
    }
  }
...
//     debugPrint('--- Update User Profile Request ---');
//     debugPrint('URL: $url');
//     debugPrint('Headers: $headers');
//     debugPrint('Body: $body');
...
//     debugPrint('--- Update Profile Photo Request ---');
//     debugPrint('URL: $url');
//     debugPrint('Headers: ${request.headers}');
//     debugPrint('File: ${imageFile.path}');
