...
import 'package:aplikasi_absensi/services/auth_service.dart';
...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  Future<void> _checkLocationAndCheckOut() async {
    setState(() {
      _isLoading = true;
    ...
    try {
      ...
      if (permission == LocationPermission.denied) {
        ...
        if (permission == LocationPermission.denied) {
          _showMessage(
            'Izin lokasi ditolak. Absen pulang dibatalkan.',
            color: Colors.red,
          );
          setState(() {
            _isLoading = false;
      ...
      setState(() {
        _statusMessage = 'Mengirim data absen pulang...';
      });
      ...
      debugPrint('Error getting location or checking out: $e');
