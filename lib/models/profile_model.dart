...
//   errors; // Untuk menangani error dari API (misal: validasi)
...
//       jenisKelamin: json['jenis_kelamin'],
//       profilePhoto: json['profile_photo'],
//       batchKe: json['batch_ke'], // Field khusus dari profile response
//       trainingTitle:
//           json['training_title'], // Field khusus dari profile response
//       batch: json['batch'] != null ? Batch.fromJson(json['batch']) : null,
//       training:
//           json['training'] != null ? Training.fromJson(json['training']) : null,
//       token:
//           json['token'], // Token mungkin ada di root data saat login/register
//     );
//   }
...
// // Model Training dipindahkan ke sini
// class Training {
//   final int id;
//   final String title;
//   final String? description;
